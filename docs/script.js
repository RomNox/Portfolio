...
<div style="max-height:calc(100% - 40px); overflow-y:auto; padding:20px;">
  <div class="resume-detail-centered">
    ...
    <h3>VOLUNTEERING</h3>
    <p>
      Led the Blood Donation Program in Ukrain. Focused on donor recruitment and steady blood supplies.
    ...
    <p>
      Youth Program Leader: Organized a youth program introducing participants to medical careers through educational events, 
    ...
    <p>
      Commander of Emergency Response Teams: Led and coordinated teams in crisis response, volunteer management, 
...
<div style="max-height:calc(100% - 40px); overflow-y:auto; padding:20px;">
  <div class="resume-detail-centered">
    ...
    <h3>VOLUNTEERING</h3>
    <p>
      Involved in various volunteer activities including the Red Cross and youth programs.
    </p>
    <br><button class="resume-btn resume-back-btn">Back</button>
  </div>
</div>
